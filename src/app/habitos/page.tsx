      ...
      <div style={{ padding: '28px 20px 0', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <button
            ...
            style={{ width: 36, height: 36, borderRadius: 10, background: 'var(--bg2)', border: '0.5px solid var(--border)', cursor: 'pointer' }}
          >
            {view === 'list' ? 'G' : 'L'}
          </button>
          <button
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                      ...
                      <button onClick={() => openEdit(habit)} style={{ width: 32, height: 32, borderRadius: 10, background: 'var(--bg3)', border: 'none', cursor: 'pointer' }}>E</button>
                      <button onClick={() => remove(habit.id)} style={{ width: 32, height: 32, borderRadius: 10, background: 'var(--bg3)', border: 'none', cursor: 'pointer' }}>X</button>
                    </div>
                  </div>
                )
              })}
