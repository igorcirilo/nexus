...
export default function AuthPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
      <div className="mb-8">
        <div className="font-syne font-extrabold text-[36px] tracking-tight mb-1"
             style={{ color: 'var(--gold)' }}>NEXUS</div>
        ...
        <div className="card p-6 w-full max-w-sm">
          ...
          {isNew && (
            <input value={name} onChange={e => setName(e.target.value)}
              ...
              style={{ background: 'var(--bg3)', border: '0.5px solid var(--border)', color: 'var(--text1)', outline: 'none', fontFamily: 'inherit' }} />
          )}

          <input value={email} onChange={e => setEmail(e.target.value)}
            type="email" placeholder="O teu email"
