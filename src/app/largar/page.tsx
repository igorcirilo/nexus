...
const plusBtn: CSSProperties = { width: 38, height: 38, borderRadius: 12, background: 'rgba(245,200,66,0.14)', border: '1px solid rgba(245,200,66,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-ink)', cursor: 'pointer', flexShrink: 0 }
...
const toastStyle: CSSProperties = { position: 'fixed', bottom: 88, left: '50%', transform: 'translateX(-50%)', background: 'var(--surface-pop)', border: '1px solid rgba(0,200,150,.38)', borderRadius: 12, padding: '10px 18px', fontSize: 13, fontFamily: FONT, color: 'var(--green-ink)', zIndex: 10000, whiteSpace: 'nowrap', maxWidth: '90vw', overflow: 'hidden', textOverflow: 'ellipsis' }
