          ...
          <>
            ...
            {step === 0 && (
              <Question label="Quantas horas dormiste esta noite?">
                ...
                <button disabled={!sleep} onClick={() => setStep(1)} style={{
            ...
            {step === 2 && (
              <Question label="Qual é a tua missão principal hoje?">
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 14, marginBottom: 20 }}>
                  ...
                  {[true, false].map(v => (
                    <button key={String(v)} onClick={() => setWillTrain(v)} style={{
                ...
                <button disabled={!mission.trim()} onClick={() => setStep(3)} style={{
            ...
            {step === 3 && (
              <Question label="Como estás emocionalmente?">
                ...
                <button disabled={submitting} onClick={() => finish('manha')} style={{
                  width: '100%', background: 'var(--gold)', color: 'var(--bg0)', border: 'none',
                  borderRadius: 14, padding: 14, fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 14, cursor: 'pointer',
                }}>{submitting ? 'A guardar…' : 'Concluir Manhã ✓'}</button>
              </Question>
            )}
          </>
        )}
          ...
          <>
            ...
            {step === 0 && (
              <Question label="O que já avançaste na missão?">
                ...
                <button disabled={!progressOpt} onClick={() => setStep(1)} style={{
            ...
            {step === 1 && (
              <Question label="Estás focado ou disperso agora?">
                ...
                <button disabled={!focusOpt} onClick={() => setStep(2)} style={{
            ...
            {step === 2 && (
              <Question label="Qual é o próximo passo imediato?">
                ...
                <button disabled={submitting} onClick={() => finish('tarde')} style={{
                  width: '100%', marginTop: 14, background: 'var(--gold)', color: 'var(--bg0)', border: 'none',
                  borderRadius: 14, padding: 14, fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 14, cursor: 'pointer',
                }}>{submitting ? 'A guardar…' : 'Concluir Tarde ✓'}</button>
              </Question>
            )}
          </>
        )}
              ...
              <Question label="Como foi a execução da tua missão?">
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {['Sim, completamente ✓', 'Em grande parte', 'Parcialmente', 'Não consegui hoje'].map(o => (
                    <button key={o} onClick={() => setMissionDone(o)} style={{
                ...
                <button disabled={!missionDone} onClick={() => setStep(1)} style={{
